...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Omnifood is a food delivery service with the mission to bring affordable and healthy meals to as many people as possible">
    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite><img src="resources/img/customer-2.jpg" alt="customer 2">Alberto Duncan</cite>
                    </blockquote>
                </div>
                ...
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite><img src="resources/img/customer-3.jpg" alt="customer 3">Alberto Duncan</cite>
                    </blockquote>
                </div>
                ...
                <div class="row" id="form">
                    <form method="post" action="mailer-new.php" class="contact-form">
                        ...
                        <div class="row">
                            ...
                            <!-- the following column will be larger than the above -->
                        ...
                        <div class="row">
                            <div class="col span-1-of-3">
                                <label>&nbsp;</label> <!-- leaves an empty space -->
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-156654978-1"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'UA-156654978-1');
        </script>
